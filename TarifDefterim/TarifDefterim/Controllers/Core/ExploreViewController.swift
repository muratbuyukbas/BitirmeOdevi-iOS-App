...
final class ExploreViewController: UIViewController, UISearchResultsUpdating {
    ...
    override func viewDidLoad() {
        ...
        searchVC.searchBar.placeholder = "Arama..."
        searchVC.searchResultsUpdater = self
        searchVC.searchBar.setValue("Kapat", forKey: "cancelButtonText")
        UIBarButtonItem.appearance().tintColor = UIColor(red: 216/255, green: 67/255, blue: 57/255, alpha: 1)
