...
final class NotificationsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private let noActivityLabel: UILabel = {
        let label = UILabel()
        label.text = "Henüz bildiriminiz yok"
    ...
    private func mockData() {
        tableView.isHidden = false
        guard let postUrl = URL(string: "https://cdn.yemek.com/mncrop/620/388/uploads/2016/06/citir-manti-one-cikan-yeni.jpg") else {
            return
        }
        guard let iconUrl = URL(string: "https://abs.firat.edu.tr/upload/user_1056/008071cf465b9c6ff3cfb550d6829ad21fab2e33_image_1056.jpg") else {
            return
        }
        ...
        DatabaseManager.shared.getPost(
            ...
            DispatchQueue.main.async {
                guard let post = post else {
                    let alert = UIAlertController(
                        title: "Oops",
                        message: "Tarif şu anda görüntülenemiyor",
                        preferredStyle: .alert
                    )
