...
//  TarifDefterim
//
//  Created by Murat Büyükbaş on 3/18/22.
//
...
class PostEditViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "İleri", style: .done, target: self, action: #selector(didTapNext))
    }
