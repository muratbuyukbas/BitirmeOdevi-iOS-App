...
class PostViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case .caption(let viewModel):
            guard let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: SinglePostCaptionCollectionViewCell.identifer,
                for: indexPath
            ) as? SinglePostCaptionCollectionViewCell else {
                fatalError()
            }
            cell.delegate = self
...
extension PostViewController: SinglePostCaptionCollectionViewCellDelegate {
    ...
    func postActionsCollectionViewCellDidTapShare(_ cell: PostActionsCollectionViewCell, index: Int) {
        ...
        case .post(let viewModel):
            let vc = UIActivityViewController(
                activityItems: ["Bu tarifi çok beğendim!", viewModel.postUrl],
...
extension PostViewController: PosterCollectionViewCellDelegate {
    func posterCollectionViewCellDidTapMore(_ cell: PosterCollectionViewCell, index: Int) {
        let sheet = UIAlertController(
            title: "Tarifi çok mu beğendin?",
            message: nil,
            preferredStyle: .actionSheet
        )
        sheet.addAction(UIAlertAction(title: "Kapat", style: .cancel, handler: nil))
        sheet.addAction(UIAlertAction(title: "Arkadaşlarınla paylaş", style: .default, handler: { [weak self]  _ in
            DispatchQueue.main.async {
...
extension PostViewController {
    func configureCollectionView() {
        ...
        collectionView.register(
            SinglePostCaptionCollectionViewCell.self,
            forCellWithReuseIdentifier: SinglePostCaptionCollectionViewCell.identifer
        )
        collectionView.register(
